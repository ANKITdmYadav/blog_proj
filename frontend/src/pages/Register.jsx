    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-100'>
     <div className='w-full max-w-md bg-white shadow-md rounded-lg p-8'>
      ...
      <div className="font-semibold text-xl items-center text-center">
        Cilli<span className="text-blue-500">Corn</span>
      </div>
      ...
      <div className='mb-4'>
        <input type="text" placeholder='Your Email Address' value={email}  onChange={(e)=>setEmail(e.target.value)} className='w-full p-2 border rounded-md'/>
      </div>
      <div className='mb-4'>
      ...
      <div className='flex items-center mb-4'>
        ...
        <input type="file" onChange={changePhotoHandler} className='w-full p-2 mb-4 border rounded-md'/>
      </div>

      <p className='text-center mb-4'>Already registered? <Link to={'/login'} className='text-blue-600'>Login now</Link></p>

      <button type='submit' className='w-full p-2 bg-blue-500 hover:bg-blue-700 duration-300 rounded-md text-white'>Register</button>
      </form>
     </div>
    </div>
